...
leaflet(data = cities) %>% 
  addTiles() %>% 
  addAwesomeMarkers(~lng, ~lat, popup = ~name, icon = awesomeIcons( icon = "globe", iconColor = "black", markerColor = "darkgreen", library = "fa" ))
```
